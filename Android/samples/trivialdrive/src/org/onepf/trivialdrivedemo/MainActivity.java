...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (TEST_MODE) {
            new AppstoreTester().run(this, "GooglePlay", new AppstoreTest[] {
                    new StupidNameTest(),
                    new BillingServiceNotNullTest(),
                    new BillingStartSuccessTest(),
                    new BillingStartFailTest(),
                    new BillingPurchaseSuccessTest(OpenIabHelper.ITEM_TYPE_INAPP),
                    new BillingPurchaseSuccessTest(OpenIabHelper.ITEM_TYPE_SUBS),
                    new BillingPurchaseFailTest(OpenIabHelper.ITEM_TYPE_INAPP),
                    new BillingPurchaseFailTest(OpenIabHelper.ITEM_TYPE_SUBS)
            });
            return;
        }
